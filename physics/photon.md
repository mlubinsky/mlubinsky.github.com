...
6. Для существования фотона нужны заряды, он взаимодействует напрямую только с заряженными частицами или с нейтральными, но во внутренней структуре которых есть заряженные части.  
7. Фотон не локализуем из-за калибровочной инвариантности и отсутствия корректного оператора координаты. Его можно локализовать, например, резонатором.  
8. Переход от совокупности фотонов к классической электромагнитной волне осуществляется через когерентное состояние. Оно отличается от классической когерентности. В нем число фотонов и фаза не фиксированы, основной критерий - минимальный квантовый шум.  
9. В вакууме фотон все же обладает некоторой локализацией из-за конструкции источников, однако, локализация определяется волновым пакетом и детектором, а не «расстоянием».  
10. Как фотон летит со скоростью с: фотон никуда не летит. Распространяется амплитуда взаимодействия <0|Е(х)|ψ>, она имеет свой фронт, распространяющийся со скоростью с, подчиняется причинности, интерферирует сама с собой.  
11. Детектирование: детектор - квантовая система с дискретными уровнями. Происходит один акт: поле -> возбуждение вещества, поэтому одна энергия, событие локальное.  
12. Коллапс - не взрыв вектора состояния фотона, а переход от суперпозиции альтернатив к одному конкретному акту.  
