...
Большинство руководств по настройке Spark сходятся во мнении, что 5 ядер (cores) на исполнителя (executor) — это оптимальное количество ядер с точки зрения параллельной обработки. 
