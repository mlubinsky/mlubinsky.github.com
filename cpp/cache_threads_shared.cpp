/*
 ...
 The shared mutex is used to enable mutiple concurrent reads
...
#define WRITELOCK lock_guard<shared_mutex>  lock(_mutex);
#define READLOCK  shared_lock<shared_mutex> lock(_mutex);
