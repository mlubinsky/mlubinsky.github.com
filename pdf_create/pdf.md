...
```
Changes:
Aspect Ratio Preservation: The image is resized based on a scale_factor, which ensures the image maintains its original aspect ratio while still fitting within the allocated space.
